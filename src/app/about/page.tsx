      ...
      <main className="w-full pt-20 sm:pt-24">
        ...
        <section className="w-full bg-pink-50 relative overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-5xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-24 lg:py-32">
            ...
            <h1 className="font-display font-bold text-brand-purple-dark leading-[1.05] mb-6 text-4xl sm:text-5xl xl:text-6xl 2xl:text-7xl">
              {headline1}<br />
              <span className="italic gradient-text">{headline2}</span>
            </h1>
            <p className="text-brand-purple-dark/80 text-base sm:text-xl leading-relaxed max-w-2xl mb-10">
              {intro}
            </p>
            {/* Section nav pills */}
        ...
        {/* ── THE JOURNEY ── */}
        <section id="journey" className="w-full bg-pink-50/50 scroll-mt-20">
          <div className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20 lg:py-24">
            ...
            <h2 className="font-display font-bold text-brand-purple-dark text-3xl sm:text-4xl xl:text-5xl mb-6 leading-tight">
              A gift carried across generations
            </h2>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-start">
              <div className="space-y-5 text-brand-purple-dark/80 text-base sm:text-lg leading-relaxed">
                <p>
                ...
                <h3 className="font-display text-xl text-brand-purple-dark pt-4">What we stand for</h3>
                <p>
                ...
                {[
                  ...
                  <div key={i} className="flex gap-5">
                    ...
                    <div className={`pb-8 ${i === arr.length - 1 ? "" : ""}`}>
                      ...
                      <h4 className="font-display text-lg text-brand-purple-dark mb-1">{item.heading}</h4>
                      <p className="text-brand-purple-dark/80 text-sm leading-relaxed">{item.body}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        {/* ── THE PROBLEM ── */}
        <section id="the-problem" className="w-full bg-pink-50 scroll-mt-20 relative overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-5xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20 lg:py-24">
            ...
            <h2 className="font-display font-bold text-brand-purple-dark text-3xl sm:text-4xl xl:text-5xl mb-4 leading-tight">
              They told us beauty was{" "}
              <span className="italic gradient-text">pain.</span>
              <br />
              <span className="text-brand-purple-dark/80 text-2xl sm:text-3xl xl:text-4xl">They lied.</span>
            </h2>
            <p className="text-brand-purple-dark/80 text-base sm:text-lg leading-relaxed mb-8 max-w-2xl">
            ...
            <div className="relative rounded-2xl overflow-hidden mb-10">
              ...
              <div className="relative z-10 px-6 sm:px-8 py-7 sm:py-8">
                <p className="font-display text-base sm:text-lg lg:text-xl text-brand-purple-dark/80 leading-relaxed">
                ...
                <p className="text-[10px] sm:text-xs text-brand-purple-dark/80 mt-3 tracking-widest uppercase">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 mb-10">
              {CHEM_SECTIONS.map((s) => (
                <div
                  key={s.eyebrow}
                  className="rounded-2xl bg-white border border-pink-200/50 p-5 sm:p-6 hover:border-brand-purple-light/20 transition-colors"
                >
                  <p className="text-[10px] tracking-[0.3em] uppercase text-brand-amber mb-2">{s.eyebrow}</p>
                  <h3 className="font-display font-bold text-brand-purple-dark text-lg sm:text-xl mb-2">{s.title}</h3>
                  <p className="text-brand-purple-dark/80 text-sm leading-relaxed">{s.summary}</p>
                </div>
              ))}
            </div>
            ...
            <Link
              href="/the-problem"
              className="inline-flex items-center gap-2 text-sm text-brand-purple-light hover:text-brand-purple-dark transition-colors"
            >
        ...
        {/* ── INGREDIENTS ── */}
        <section id="ingredients" className="w-full bg-pink-50/50 scroll-mt-20">
          <div className="w-full max-w-5xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20 lg:py-24">
            ...
            <p className="text-brand-purple-dark/80 text-base sm:text-lg leading-relaxed mb-10 max-w-2xl">
            ...
            <p className="mt-10 text-brand-purple-dark/80 text-sm leading-relaxed">
              We never use parabens, phthalates, sulphates (SLS / SLES), synthetic fragrance, triclosan, or hidden
              preservatives.
            </p>
            <Link
              href="/ingredients"
              className="inline-flex items-center gap-2 mt-4 text-sm text-brand-purple-light hover:text-brand-purple-dark transition-colors"
            >
        ...
        {/* ── SUSTAINABILITY ── */}
        <section id="sustainability" className="w-full bg-pink-50 scroll-mt-20">

          {/* Stats strip */}
          <div className="w-full border-b border-pink-200/50 bg-pink-50/50">
              ...
              <div className="grid grid-cols-3 gap-6">
                {STATS.map((s) => (
                  <div key={s.label} className="text-center">
                    ...
                    <p className="text-[10px] sm:text-xs tracking-wide text-brand-purple-dark/80">{s.label}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="w-full max-w-5xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20 lg:py-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 mb-14">
              {PILLARS.map((p, i) => (
                <div
                  key={p.title}
                  className="rounded-2xl bg-white border border-pink-200/50 p-5 sm:p-6 hover:border-brand-amber/20 transition-colors"
                >
                  <p className="text-[10px] tracking-[0.3em] uppercase text-brand-amber mb-2">0{i + 1}</p>
                  <h3 className="font-display font-bold text-brand-purple-dark text-lg mb-2">{p.title}</h3>
                  <p className="text-brand-purple-dark/80 text-sm leading-relaxed">{p.body}</p>
                </div>
              ))}
            </div>
            ...
            <div className="mb-10">
              ...
              <h3 className="font-display font-bold text-brand-purple-dark text-2xl sm:text-3xl mb-3">
                Three co-operatives, named
              </h3>
              <p className="text-brand-purple-dark/80 text-sm sm:text-base max-w-xl mb-8 leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {CO_OPS.map((c) => (
                  <div
                    key={c.name}
                    className="rounded-2xl bg-white border border-pink-200/50 overflow-hidden hover:border-brand-amber/25 transition-colors"
                  >
                    ...
                    <div className="p-5">
                      ...
                      <h4 className="font-display text-base font-semibold text-brand-purple-dark mb-1">{c.name}</h4>
                      <p className="text-xs text-brand-purple-dark/80 leading-relaxed">{c.detail}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        {/* ── OUR CULTURE ── */}
        <section id="culture" className="w-full bg-pink-50/50 scroll-mt-20 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-start mb-12">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <div
                    key={v.label}
                    className="rounded-xl bg-white border border-pink-200/50 p-4 hover:border-brand-purple-light/20 transition-colors"
                  >
                    <span className="text-brand-purple-light text-xs mb-2 block">{v.icon}</span>
                    <p className="font-display text-brand-purple-dark text-sm font-semibold mb-0.5">{v.label}</p>
                    <p className="text-brand-purple-dark/80 text-xs leading-snug">{v.desc}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        {/* ── CTA ── */}
        <section className="w-full bg-pink-50 border-t border-pink-200/50">
          <div className="w-full max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 py-16 sm:py-20 text-center">
            <p className="font-display italic text-brand-purple-dark text-xl sm:text-2xl xl:text-3xl leading-relaxed max-w-2xl mx-auto mb-3">
            ...
            <h2 className="font-display font-bold text-brand-purple-dark text-2xl sm:text-3xl mb-4">
              Built without compromise
            </h2>
            <p className="text-brand-purple-dark/80 text-base sm:text-lg max-w-xl mx-auto mb-8 leading-relaxed">
