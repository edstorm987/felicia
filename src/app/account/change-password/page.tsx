    ...
    <>
      ...
      <main className="w-full pt-20 sm:pt-24 bg-pink-50 min-h-screen">
        <div className="w-full max-w-md mx-auto px-6 sm:px-8 py-14 sm:py-20">
          ...
          <p className="text-brand-purple-dark/80 leading-relaxed mb-2">
            {forced
              ? "Your account was created with a temporary password. Set your own before continuing."
              : "Enter your current password, then choose a new one. At least 8 characters."}
          </p>
          {email && (
            <p className="text-brand-purple-dark/80 text-xs mb-8">Signed in as {email}.</p>
          )}
          ...
          {done ? (
            <div className="rounded-2xl border border-brand-amber/30 bg-brand-amber/10 px-5 py-4">
              ...
              <p className="text-brand-purple-dark/80 text-xs mt-2">Redirecting…</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-[11px] tracking-[0.22em] uppercase text-brand-purple-dark/80 mb-2">
                  Current password
                </label>
                <input
                  type="password"
                ...
                />
                {forced && (
                  <p className="text-[10px] text-brand-purple-dark/80 mt-1.5">
