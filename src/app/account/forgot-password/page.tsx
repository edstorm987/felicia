    ...
    <>
      ...
      <main className="w-full pt-20 sm:pt-24 bg-pink-50 min-h-screen">
        <div className="w-full max-w-md mx-auto px-6 sm:px-8 py-14 sm:py-20">
          ...
          <h1 className="font-display font-bold text-brand-purple-dark text-3xl sm:text-4xl leading-tight mb-3">
          ...
          {!sent ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-[11px] tracking-[0.22em] uppercase text-brand-purple-dark/80 mb-2">Email</label>
                <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                  required placeholder="you@example.com"
                  className="w-full bg-white border border-pink-200 rounded-xl px-4 py-3.5 text-sm text-brand-purple-dark placeholder:text-brand-purple-dark/80 focus:outline-none focus:border-brand-orange/40 transition-colors" />
              </div>
            ...
            <div className="space-y-4">
              ...
              {sent.devLink && (
                <div className="rounded-2xl border border-pink-200 bg-white px-5 py-4">
                  <p className="text-[11px] tracking-[0.2em] uppercase text-brand-purple-dark/80 mb-2">
          ...
          <p className="text-xs text-brand-purple-dark/80 mt-8 text-center">
            <Link href="/account" className="text-brand-purple-dark/80 hover:underline">← Back to log in</Link>
          </p>
        </div>
      </main>
      <Footer />
