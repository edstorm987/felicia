  ...
  return (
    <>
      ...
      <main className="w-full pt-32 pb-20 min-h-screen bg-pink-50">
        {variant === undefined ? (
          <div className="max-w-3xl mx-auto px-6 text-brand-purple-dark/80">Loading…</div>
        ) : useVariant ? (
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 space-y-6">
      <header className="text-center">
        ...
        <h1 className="font-display text-4xl sm:text-5xl text-brand-purple-dark">Your orders</h1>
        <p className="text-brand-purple-dark/80 text-sm mt-2">Every order you've placed with us, with status and tracking.</p>
      </header>
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    <p className="text-sm text-brand-purple-dark font-mono truncate">{o.id}</p>
                  ...
                  <div className="text-right shrink-0">
                    <p className="text-sm text-brand-purple-dark">£{o.total.toFixed(2)}</p>
                    <p className="text-[10px] tracking-wider uppercase text-brand-purple-dark/80">{o.status}</p>
                  </div>
                </div>
              </Link>
            </li>
      ...
      <p className="text-[11px] text-brand-purple-dark/80 text-center pt-4">
        Operators can redesign this page with the visual editor — open <code className="font-mono text-brand-purple-dark/80">/admin/portals</code> → Orders.
      </p>
    </div>
  );
}
