        ...
        <div className="w-full max-w-md mx-auto px-6 sm:px-8 py-14 sm:py-20">
          ...
          {done ? (
            <div className="rounded-2xl border border-brand-amber/30 bg-brand-amber/10 px-5 py-4">
              ...
              <p className="text-brand-purple-dark/80 text-xs mt-2">Redirecting you to your account…</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-[11px] tracking-[0.22em] uppercase text-brand-purple-dark/80 mb-2">New password</label>
              ...
              <div>
                <label className="block text-[11px] tracking-[0.22em] uppercase text-brand-purple-dark/80 mb-2">Confirm password</label>
