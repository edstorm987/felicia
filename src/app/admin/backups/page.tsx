    ...
    <div className="p-6 sm:p-8 lg:p-10 max-w-5xl space-y-6">
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <h1 className="font-display text-3xl sm:text-4xl text-brand-purple-dark">Backups</h1>
      ...
      {loading ? (
        ...
        <section className="rounded-2xl border border-white/8 bg-white p-8 text-center">
          ...
          <p className="text-[12px] text-brand-purple-dark/80 mt-2 max-w-md mx-auto leading-relaxed">
            ...
            <code className="font-mono text-brand-purple-dark/80">POST /api/portal/backups</code> for scheduled snapshots.
          </p>
        </section>
      ) : (
          ...
          {backups.map(b => (
            <li key={b.id} className="px-4 py-3 flex flex-wrap items-center gap-3">
              <div className="flex-1 min-w-[12rem]">
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-[13px] text-brand-purple-dark font-mono">{b.id}</span>
                  ...
                  <span className="text-[10px] text-brand-purple-dark/80">{b.adapter}</span>
                </div>
