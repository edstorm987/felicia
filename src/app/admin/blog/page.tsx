    ...
    <div className="p-6 sm:p-8 lg:p-10 space-y-6 max-w-6xl">
      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <h1 className="font-display text-3xl sm:text-4xl text-brand-purple-dark">Journal posts</h1>
        ...
        <div className="flex gap-2">
          <Link href="/blog" target="_blank" className="text-xs px-3 py-2 rounded-lg border border-pink-200 text-brand-purple-dark/80 hover:text-brand-purple-dark">View live →</Link>
      ...
      {filtered.length === 0 ? (
        <div className="rounded-2xl border border-white/8 bg-white px-6 py-10 text-center">
          <p className="text-brand-purple-dark/80 text-sm">No posts yet.</p>
          ...
          {filtered.map(p => (
            <div key={p.id} className="flex items-center gap-4 px-5 py-4 hover:bg-white/[0.02] transition-colors">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <Link href={`/blog/${p.slug}`} target="_blank" className="text-[11px] text-brand-purple-dark/80 hover:text-brand-purple-dark">View</Link>
                <button
