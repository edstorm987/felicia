...
function DonorsPageInner() {
  ...
  return (
    <div className="p-6 sm:p-8 lg:p-10 max-w-5xl space-y-6">
      <Link href="/admin/donations" className="text-xs text-brand-purple-dark/80 hover:text-brand-purple-dark inline-block">
        ← Donations
      </Link>
      ...
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <h1 className="font-display text-3xl sm:text-4xl text-brand-purple-dark">Donors</h1>
      ...
      {loading ? (
        ...
        <section className="rounded-2xl border border-pink-200/50 bg-white p-8 text-center">
          <p className="text-[13px] text-brand-purple-dark/80">No donors yet</p>
            ...
            <li key={d.email} className="px-4 py-3 flex flex-wrap items-center gap-3">
              <div className="flex-1 min-w-[12rem]">
                <div className="text-[13px] text-brand-purple-dark">
                  {d.alwaysAnonymous ? <em className="text-brand-purple-dark/80">Anonymous</em> : d.displayName}
                </div>
                <Link
              ...
              <div className="text-[10px] text-brand-purple-dark/80 tabular-nums w-24 text-right">
