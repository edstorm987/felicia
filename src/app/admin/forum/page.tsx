    ...
    <main className="max-w-4xl mx-auto px-6 py-8 space-y-6">
      ...
      <header className="flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="font-display text-3xl text-brand-purple-dark">Community</h1>
      ...
      <section>
        <h2 className="text-[10px] tracking-[0.28em] uppercase text-brand-purple-dark/80 mb-3">Recent topics</h2>
        {topics.length === 0 ? (
          <div className="rounded-xl border border-pink-200/50 bg-white/[0.02] p-6 text-center">
            <p className="text-[13px] text-brand-purple-dark/80">No topics yet.</p>
            <p className="text-[12px] text-brand-purple-dark/80 mt-2 max-w-sm mx-auto">
              Topics are created by signed-in visitors on the storefront <code className="font-mono text-brand-purple-dark/80">/forum</code> page.
          ...
          <ul className="space-y-1">
            {topics.slice(0, 30).map(t => (
              <li key={t.id} className="rounded-lg border border-pink-200/50 bg-white/[0.02] px-4 py-3 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[12px] text-brand-purple-dark truncate">{t.title}</p>
