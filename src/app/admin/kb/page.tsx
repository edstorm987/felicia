    ...
    <main className="max-w-4xl mx-auto px-6 py-8 space-y-6">
      ...
      <header className="flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="font-display text-3xl text-brand-purple-dark">Articles</h1>
      ...
      {articles.length === 0 ? (
        <div className="rounded-xl border border-pink-200/50 bg-white/[0.02] p-6 text-center">
          <p className="text-[13px] text-brand-purple-dark/80">No knowledge-base articles yet.</p>
          <p className="text-[12px] text-brand-purple-dark/80 mt-2 max-w-sm mx-auto">
            Articles surface on your storefront <code className="font-mono text-brand-purple-dark/80">/help</code> index. Group them under{" "}
        ...
        <ul className="space-y-1">
          {articles.map(a => (
            <li key={a.id} className="rounded-lg border border-pink-200/50 bg-white/[0.02] px-4 py-3 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[13px] text-brand-purple-dark truncate">{a.title}</p>
