    ...
    return (
      <>
        ...
        <main className="w-full pt-32 pb-20 min-h-screen bg-pink-50">
          <p className="max-w-3xl mx-auto px-6 text-brand-purple-dark/80">Loading variant…</p>
        </main>
        <Footer />
      </>
    );
      ...
      <main className="w-full pt-32 pb-20 min-h-screen bg-pink-50">
        {isEmpty ? (
          <div className="max-w-3xl mx-auto px-6 space-y-3 text-center">
            <p className="text-brand-purple-dark/80 text-sm">This variant has no blocks yet.</p>
