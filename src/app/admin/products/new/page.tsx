  ...
  return (
    <div className="p-6 sm:p-8 lg:p-10 space-y-6 max-w-2xl">
      ...
      <div>
        ...
        <h1 className="font-display text-3xl sm:text-4xl text-brand-purple-dark">Add a product</h1>
        <p className="text-brand-purple-dark/80 text-sm mt-1">Creates a new product in your catalogue. You can edit all details after saving.</p>
      </div>
      ...
      <div className="rounded-2xl border border-white/8 bg-white p-5 sm:p-6 space-y-4">
        ...
        <Field label="Slug (URL handle) *">
          <div className="flex items-center gap-2">
            <span className="text-xs text-brand-purple-dark/80 shrink-0">/products/</span>
            <input
              value={slug}
          ...
          <p className="text-[10px] text-brand-purple-dark/80 mt-1">Lowercase letters, numbers, and hyphens only. Cannot be changed later.</p>
        </Field>
      ...
      <div className="flex items-center justify-end gap-3">
        <Link href="/admin/products" className="text-sm text-brand-purple-dark/80 hover:text-brand-purple-dark px-4 py-2">
          Cancel
        </Link>
        <button
