    ...
    <section className="rounded-2xl border border-white/8 bg-white p-6 sm:p-8 space-y-3">
      ...
      >
        <input
          ...
          className="flex-1 min-w-[16rem] bg-white/5 border border-pink-200 rounded-xl px-3 py-2 text-sm text-brand-purple-dark focus:outline-none focus:border-brand-orange/50"
        />
        <button
          type="submit"
