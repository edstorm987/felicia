...
function ColorRow({
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-2.5 border-b border-pink-200/50 last:border-0">
      <span className="text-sm text-brand-purple-dark/80 flex-1">{label}</span>
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          value={value}
          onChange={(e) => onChange(e.target.value)}
          className="w-24 text-xs bg-white/5 border border-pink-200 rounded-lg px-2 py-1.5 text-brand-purple-dark font-mono focus:outline-none focus:border-brand-orange/50"
        />
      </div>
    </div>
  );
...
function SliderRow({
  ...
  return (
    <div className="py-2.5 border-b border-pink-200/50 last:border-0">
      <div className="flex items-center justify-between mb-2">
        <span className="text-sm text-brand-purple-dark/80">{label}</span>
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-2.5 border-b border-pink-200/50 last:border-0">
      ...
      <select
        value={value}
        onChange={(e) => onChange(e.target.value)}
        className="text-sm bg-white/5 border border-pink-200 rounded-lg px-2 py-1.5 text-brand-purple-dark focus:outline-none focus:border-brand-orange/50"
      >
        {options.map((o) => (
...
function ToggleRow({
  ...
  return (
    <div className="flex items-center justify-between gap-4 py-3 border-b border-pink-200/50 last:border-0">
      <div>
        <p className="text-sm text-brand-purple-dark/80">{label}</p>
        {desc && <p className="text-xs text-brand-purple-dark/80 mt-0.5">{desc}</p>}
      </div>
      <button
  ...
  return (
    <div className="rounded-xl border border-pink-200/50 bg-white/[0.02] overflow-hidden mb-3">
            ...
            <button
              ...
              className={`text-[11px] px-2.5 py-1 rounded-lg transition-colors ${
                value.type === t.value
                  ...
                  : "bg-white/5 text-brand-purple-dark/80 hover:text-brand-purple-dark hover:bg-white/10"
              }`}
            >
              {t.label}
            </button>
      ...
      <div className="px-4 py-3 space-y-0">
        ...
        {value.type === "image" && (
          <>
            <div className="py-2.5 border-b border-pink-200/50">
              <label className="text-sm text-brand-purple-dark/80 block mb-1.5">Image URL</label>
              <input
                type="text"
                value={value.image}
                placeholder="/images/hero/my-image.jpg"
                onChange={(e) => onChange({ ...value, image: e.target.value })}
                className="w-full text-sm bg-white/5 border border-pink-200 rounded-lg px-3 py-2 text-brand-purple-dark focus:outline-none focus:border-brand-orange/50"
              />
            </div>
            <SelectRow
              label="Size"
        ...
        {value.type === "transparent" && (
          <p className="py-2 text-xs text-brand-purple-dark/80">
  ...
  return (
    <div className="p-6 sm:p-8 lg:p-10 max-w-4xl space-y-6">
        ...
        {TABS.map((t) => (
          <button
            ...
            className={`px-4 py-2.5 text-sm font-medium whitespace-nowrap border-b-2 transition-colors -mb-px ${
              tab === t.id
                ? "border-brand-orange text-brand-purple-dark"
                : "border-transparent text-brand-purple-dark/80 hover:text-brand-purple-dark/80"
            }`}
          >
            {t.label}
          </button>
              ...
              {Object.entries(theme.colors).map(([k, v]) => (
                <div key={k} className="flex flex-col items-center gap-1">
                  <div
                    ...
                    title={k}
                  />
                  <span className="text-[9px] text-brand-purple-dark/80 font-mono">{v}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {tab === "typography" && (
        <div className="space-y-6">
          <Section title="Fonts">
            <p className="text-xs text-brand-purple-dark/80 pb-2">
          ...
          <div className="rounded-xl border border-pink-200/50 p-5 space-y-3">
            ...
            <p
              ...
              className="text-brand-purple-dark"
            >
              The soil of Ghana
            </p>
            <p
              ...
              className="text-brand-purple-dark/80"
            >
      ...
      {tab === "highlights" && (
        <div className="space-y-6">
          ...
          <Section title="Text selection">
            ...
            />
            <div className="py-2">
              <p className="text-sm text-brand-purple-dark/80 mb-1">Preview (select this text):</p>
              <p
                className="text-brand-purple-dark text-sm p-3 rounded-xl border border-pink-200"
                style={{
      ...
      {tab === "animations" && (
        <div className="space-y-6">
          ...
          <Section title="Scrolling marquees">
            ...
            />
            <p className="text-[11px] text-brand-purple-dark/80 -mt-1 pb-1">
            ...
            />
            <p className="text-[11px] text-brand-purple-dark/80 -mt-1">
      ...
      {tab === "variants" && (
        <div className="space-y-6">
          ...
          <Section title="Site default variant">
            <div className="py-2">
              <p className="text-xs text-brand-purple-dark/80 mb-3">Choose which variant visitors see when they first arrive.</p>
              ...
              {variants.map(v => (
                <div key={v.id} className="flex items-center gap-3 py-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-brand-purple-dark font-medium">{v.name}</p>
                    {v.description && <p className="text-xs text-brand-purple-dark/80 mt-0.5 truncate">{v.description}</p>}
                    {v.isBuiltIn && <span className="text-[10px] text-brand-purple-dark/80">Built-in</span>}
                  </div>
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="text-xs px-2.5 py-1 rounded-lg border border-pink-200 text-brand-purple-dark/80 hover:text-brand-purple-dark"
                    >
                      Clone
                    </button>
                    {!v.isBuiltIn && (
                      <>
                        ...
                        <button
                          ...
                          className="text-xs px-2.5 py-1 rounded-lg border border-pink-200 text-brand-purple-dark/80 hover:text-brand-orange"
                        >
                          Delete
                        </button>
                      </>
