    ...
    <main className="max-w-5xl mx-auto p-6 space-y-6">
      ...
      <header className="flex items-baseline justify-between gap-4">
        <div>
          ...
          <h1 className="font-display text-3xl text-brand-purple-dark">Themes</h1>
          <p className="text-[12px] text-brand-purple-dark/80 mt-1">Site: <span className="text-brand-purple-dark/80">{site.name}</span></p>
        </div>
      ...
      {creating && (
        <form onSubmit={handleCreate} className="rounded-2xl border border-pink-200 bg-white/[0.02] p-4 space-y-3">
          <div className="grid sm:grid-cols-2 gap-3">
            ...
            <label className="block">
              <span className="block text-[10px] tracking-[0.18em] uppercase text-brand-purple-dark/80 mb-1">Appearance</span>
      ...
      <div className="space-y-4">
        {themes.map(theme => (
          <details key={theme.id} className="rounded-2xl border border-pink-200 bg-white/[0.02] overflow-hidden" open={theme.isDefault}>
            <summary className="cursor-pointer px-4 py-3 flex items-center gap-3 hover:bg-white/[0.02]">
              ...
              <span className="font-semibold text-brand-purple-dark">{theme.name}</span>
            ...
            <div className="p-4 border-t border-pink-200/50 space-y-3">
                      ...
                      {kind === "color" ? (
                        <div className="flex gap-2">
                          <input
                            ...
                            className="w-10 h-8 rounded cursor-pointer bg-transparent border border-pink-200"
                          />
                          <input
                            defaultValue={value}
              ...
              <details className="rounded-lg border border-pink-200/50 bg-white/[0.02] overflow-hidden">
                <summary className="cursor-pointer px-3 py-2 text-[11px] tracking-[0.18em] uppercase text-brand-purple-dark/80">Custom CSS (advanced)</summary>
