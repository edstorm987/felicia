    ...
    <main className="max-w-4xl mx-auto px-6 py-8 space-y-4">
      <header className="flex items-center justify-between">
        <div>
          ...
          <h1 className="font-display text-3xl text-brand-purple-dark">Delivery log</h1>
        </div>
      ...
      {loading ? (
        ...
        <p className="text-[12px] text-brand-purple-dark/80">No deliveries yet — outbound calls will appear here once events fire.</p>
      ) : (
          ...
          {log.map(d => (
            <article key={d.id} className="rounded-lg border border-pink-200/50 bg-white/[0.02] px-4 py-3 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[12px] font-mono text-brand-purple-dark truncate">{d.event}</p>
