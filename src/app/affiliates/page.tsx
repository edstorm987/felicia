...
function DefaultAffiliatesLanding() {
  return (
    <div className="max-w-3xl mx-auto px-6 space-y-6 text-center">
      ...
      <h1 className="font-display text-4xl sm:text-5xl text-brand-purple-dark">Affiliate program</h1>
      <p className="text-brand-purple-dark/80 text-sm sm:text-base leading-relaxed max-w-prose mx-auto">
      ...
      <p className="text-[11px] text-brand-purple-dark/80 pt-4">
        Operators can design this page with the visual editor — open <code className="font-mono text-brand-purple-dark/80">/admin/portals</code> → Affiliates.
      </p>
    </div>
  );
}
