      ...
      <header className="px-6 py-4 border-b border-white/8 flex items-center gap-4">
        <Link href="/aqua" className="flex items-center gap-2 group">
          <span
            ...
            aria-hidden="true"
          />
          <span className="font-display text-xl font-bold text-brand-purple-dark group-hover:text-brand-orange transition-colors">
            Aqua portal
          </span>
        </Link>
        <span className="text-[11px] tracking-[0.18em] uppercase text-brand-purple-dark/80 hidden sm:inline">Agency dashboard</span>
        ...
        <Link href="/admin" className="text-[12px] text-brand-purple-dark/80 hover:text-brand-purple-dark">
          Skip to admin →
        </Link>
      </header>
      {children}
