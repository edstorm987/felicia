...
function SuccessContent() {
  ...
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-pink-50 flex items-center justify-center px-6 pt-24">
        <div className="max-w-lg text-center">
          <p className="text-[11px] tracking-[0.3em] uppercase text-brand-amber mb-4">Order confirmed</p>
          <h1 className="font-display text-4xl sm:text-5xl text-brand-purple-dark mb-4">Asante.</h1>
          ...
          {sessionId && (
            <p className="text-[11px] text-brand-purple-dark/80 font-mono mb-8 break-all">Reference: {sessionId}</p>
          )}
