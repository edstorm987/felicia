...
export default function PortalEmbedLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-pink-50 text-brand-purple-dark font-body antialiased flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="rounded-2xl border border-pink-200 bg-pink-50/50 p-6 shadow-2xl">
          {theme.logoUrl ? (
          ...
          <h1 className="font-display text-2xl text-brand-purple-dark mb-1">
            {headline}
          </h1>
          <p className="text-[12px] text-brand-purple-dark/80 mb-5">{subtitle}</p>

          {signedInAs ? (
            <div className="space-y-3">
              <div className="px-3 py-2.5 rounded-xl bg-white/5 border border-pink-200 text-[12px] text-brand-purple-dark/80">
                {signedInAs.email}
              </div>
              <button
          ...
          {theme.showAdminLink && !signedInAs && (
            <div className="mt-5 pt-4 border-t border-pink-200/50 text-center">
              <a
                ...
                className="text-[12px] text-brand-purple-dark/80 hover:text-brand-purple-dark"
              >
                {adminLabel}
              </a>
            </div>
          ...
          <p className="text-[10px] text-brand-purple-dark/80 mt-5 text-center">
