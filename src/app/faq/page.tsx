    ...
    <>
      ...
      >
        <nav className="not-prose flex flex-wrap gap-2 mb-10">
          {groups.map(g => (
            <a
              ...
              className="px-4 py-2 text-xs sm:text-sm rounded-full border border-pink-200 text-brand-purple-dark/80 hover:border-brand-orange/40 hover:text-brand-purple-dark transition-colors"
            >
              {g.heading}
            </a>
          ))}
        ...
        {groups.map(group => (
          ...
          >
            <h2 className="font-display text-2xl xl:text-3xl text-brand-purple-dark font-bold">{group.heading}</h2>
            <div className="space-y-3">
              {group.items.map(f => (
                ...
                >
                  ...
                  <p className="mt-3 text-sm text-brand-purple-dark/80 leading-relaxed whitespace-pre-wrap">{f.answer}</p>
                </details>
              ))}
            </div>
          </section>
        ...
        <div className="not-prose mt-12 p-6 rounded-2xl bg-gradient-to-br from-brand-purple-muted/30 to-brand-black-card border border-pink-200/50 text-center">
          <p className="text-brand-purple-dark/80 mb-3">Still have a question?</p>
          <p className="text-sm text-brand-purple-dark/80 mb-5">
