      ...
      <main className="w-full pt-20 sm:pt-24">
        ...
        <section className="w-full bg-pink-50 relative overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 py-14 sm:py-20 lg:py-24">
            ...
            <p className="text-brand-purple-dark/80 text-base sm:text-lg xl:text-xl leading-relaxed mb-5">
              {intro}
            </p>
            <p className="text-brand-purple-dark/80 text-base leading-relaxed">
        ...
        {/* Stats strip */}
        <section className="w-full bg-pink-50/50 border-y border-pink-200/50">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {[
                ...
                <div key={s.small} className="text-center">
                  ...
                  <p className="text-xs sm:text-sm tracking-wide text-brand-purple-dark/80">{s.small}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Panels */}
        <section id="panels" className="w-full bg-pink-50">
          <div className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20 lg:py-24">
            <div className="flex flex-col items-center text-center mb-14">
              ...
              <h2 className="font-display font-bold text-brand-purple-dark text-3xl sm:text-4xl xl:text-5xl">Six panels per test</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 xl:gap-6">
              {PANELS.map((p) => (
                <div
                  key={p.title}
                  className="flex flex-col p-7 xl:p-8 rounded-2xl bg-white border border-pink-200/50 hover:border-brand-amber/30 transition-colors"
                >
            ...
            {/* Lab process photo */}
            <div className="relative mt-14 rounded-2xl overflow-hidden border border-pink-200/50">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                ...
                <div className="flex flex-col justify-center p-8 sm:p-10 xl:p-12 bg-white">
                  <span className="text-[11px] tracking-[0.28em] uppercase text-brand-amber mb-3">Our Process</span>
                  <h3 className="font-display text-xl sm:text-2xl xl:text-3xl font-bold text-brand-purple-dark mb-4 leading-tight">
                    From Ghana to the lab — and only then to you
                  </h3>
                  <p className="text-sm sm:text-base text-brand-purple-dark/80 leading-relaxed">
        ...
        <section id="latest" className="w-full bg-pink-50/50">
          <div className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5 mb-10">
              <div>
                ...
                <h2 className="font-display font-bold text-brand-purple-dark text-3xl sm:text-4xl xl:text-5xl">Recent batch reports</h2>
              </div>
              <a
            ...
            <div className="overflow-x-auto -mx-6 sm:mx-0">
              <div className="min-w-[640px] sm:min-w-0 px-6 sm:px-0">
                <div className="rounded-2xl border border-pink-200/50 overflow-hidden bg-white">
                  <div className="hidden sm:grid grid-cols-12 gap-4 px-6 py-4 text-[10px] tracking-[0.22em] uppercase text-brand-purple-dark/80 border-b border-pink-200/50 bg-pink-50/40">
                  ...
                  {RECENT_BATCHES.map((b) => (
                    <div
                      key={b.batch}
                      className="grid grid-cols-1 sm:grid-cols-12 gap-2 sm:gap-4 px-6 py-5 border-b border-pink-200/50 last:border-b-0 hover:bg-white/[0.015] transition-colors"
                    >
                      <div className="sm:col-span-3 flex items-center gap-3">
                        ...
                        <span className="font-mono text-xs sm:text-sm text-brand-purple-dark tracking-wide">{b.batch}</span>
                      </div>
                      <p className="sm:col-span-4 text-sm text-brand-purple-dark/80">{b.product}</p>
                      <p className="sm:col-span-2 text-sm text-brand-purple-dark/80">{b.date}</p>
                      <p className="sm:col-span-2 text-sm text-brand-purple-dark/80">{b.lab}</p>
                      <a
                        href="#"
            ...
            <p className="text-xs text-brand-purple-dark/80 mt-5">
        ...
        {/* Lab partners */}
        <section id="labs" className="w-full bg-pink-50">
          <div className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20">
            <div className="flex flex-col items-center text-center mb-12">
              <span className="text-xs tracking-[0.28em] uppercase text-brand-amber mb-3">Our labs</span>
              <h2 className="font-display font-bold text-brand-purple-dark text-3xl sm:text-4xl xl:text-5xl mb-4">Three independent partners</h2>
              <p className="text-brand-purple-dark/80 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 xl:gap-6">
              {PARTNERS.map((p) => (
                <div
                  key={p.name}
                  className="p-7 rounded-2xl bg-white border border-pink-200/50 hover:border-brand-amber/25 transition-colors"
                >
                  <h3 className="font-display text-xl font-semibold text-brand-purple-dark mb-1">{p.name}</h3>
                  <p className="text-xs tracking-wide uppercase text-brand-amber mb-4">{p.location}</p>
                  <p className="text-sm text-brand-purple-dark/80 leading-relaxed mb-4">{p.role}</p>
                  <p className="text-[11px] tracking-widest uppercase text-brand-purple-dark/80">{p.accreditation}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* CTA */}
        <section className="w-full bg-pink-50/50 border-t border-pink-200/50">
          <div className="w-full max-w-3xl mx-auto px-6 sm:px-10 lg:px-12 py-14 sm:py-20 text-center">
            <h2 className="font-display font-bold text-brand-purple-dark text-2xl sm:text-3xl xl:text-4xl mb-4">
