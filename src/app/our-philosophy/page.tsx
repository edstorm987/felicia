  ...
  return (
    <>
      ...
      <main className="w-full pt-20 sm:pt-24">
        ...
        <section className="w-full bg-pink-50 relative overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 py-16 sm:py-20 lg:py-24">
            ...
            <h1 className="font-display font-bold text-brand-purple-dark leading-[1.05] mb-6 text-4xl sm:text-5xl xl:text-6xl 2xl:text-7xl">
              ...
              <br />
              <span className="text-brand-purple-dark/80 text-3xl sm:text-4xl md:text-5xl xl:text-6xl">{headline4}</span>
            </h1>
            <div className="space-y-5 text-brand-purple-dark/80 text-base sm:text-lg xl:text-xl leading-[1.8] mb-8">
              <p>{intro}</p>
              <p>{intro2}</p>
              <p className="text-brand-purple-dark/80">{intro3}</p>
            </div>
        ...
        {/* Sections */}
        <section id="sections" className="w-full bg-pink-50/50">
          <div className="w-full max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 py-14 sm:py-20 space-y-14 sm:space-y-16">
            {SECTIONS.map(({ eyebrow, title, body }) => (
              <article key={title}>
                ...
                <h2 className="font-display font-bold text-brand-purple-dark text-2xl sm:text-3xl xl:text-4xl leading-tight mb-5">
                  {title}
                </h2>
                <div className="space-y-4">
                  {body.map((p, i) => (
                    <p
                      key={i}
                      className="text-brand-purple-dark/80 text-base sm:text-lg leading-relaxed"
        ...
        {/* Sources */}
        <section id="sources" className="w-full bg-pink-50">
          <div className="w-full max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 py-14 sm:py-20">
            ...
            <h2 className="font-display font-bold text-brand-purple-dark text-2xl sm:text-3xl xl:text-4xl mb-8">Sources &amp; further reading</h2>
            <ol className="space-y-4">
              {SOURCES.map((s) => (
                <li
                  id={`source-${s.n}`}
                  key={s.n}
                  className="flex gap-4 p-5 rounded-xl bg-white border border-pink-200/50 scroll-mt-28"
                >
                  ...
                  <div className="min-w-0">
                    <p className="text-sm sm:text-base text-brand-purple-dark/80 leading-relaxed">{s.label}</p>
                    <a
                      href={s.href}
                      target="_blank"
            ...
            <p className="text-xs text-brand-purple-dark/80 mt-8 leading-relaxed">
