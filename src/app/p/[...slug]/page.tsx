      ...
      fallback={
        <div className="min-h-screen flex items-center justify-center p-6">
          <div className="max-w-md text-center">
            ...
            <h1 className="font-display text-3xl text-brand-purple-dark mb-2">Page not found</h1>
            <p className="text-[12px] text-brand-purple-dark/80">No portal-managed page matches <code className="font-mono text-brand-purple-dark/80">{path}</code>. Build one in the visual editor.</p>
          </div>
        </div>
      }
      loading={null}
