  ...
  return (
    <>
      ...
      <main className="w-full bg-pink-50 min-h-screen">
        ...
        {/* Hero */}
        <section className="w-full pt-28 pb-20 sm:pt-36 sm:pb-24 bg-pink-50/50 overflow-hidden relative">
            ...
            <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
              ...
              {!code ? (
                <form onSubmit={handleSubmit} className="w-full max-w-md flex flex-col gap-3">
                  <p className="text-brand-purple-dark/80 text-sm">{codePrompt}</p>
                  <div className="flex gap-2">
                    <input
                      ...
                      required
                      className="flex-1 bg-white border border-pink-200 rounded-xl px-4 py-3 text-brand-purple-dark text-sm placeholder:text-brand-purple-dark/80 focus:outline-none focus:border-brand-orange/50 transition-colors"
                    />
                    <button
                      type="submit"
                ...
                <div className="w-full max-w-md flex flex-col gap-3">
                  <p className="text-brand-purple-dark/80 text-sm">{shareNote}</p>
                  <div className="flex gap-2 p-1 bg-white border border-pink-200 rounded-xl">
        ...
        <section className="w-full py-16 sm:py-20">
          <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16">
            <div className="flex flex-col items-center text-center mb-12">
              ...
              <h2 className="font-display font-bold text-brand-purple-dark text-2xl sm:text-3xl xl:text-4xl">
                Three simple steps
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {[
                ...
                <div key={s.step} className="flex flex-col p-7 rounded-2xl bg-white border border-pink-200/50">
                  <span className="font-display text-4xl font-bold text-brand-orange/20 mb-4">{s.step}</span>
                  <h3 className="font-display font-bold text-brand-purple-dark text-lg mb-2">{s.title}</h3>
                  <p className="text-brand-purple-dark/80 text-sm leading-relaxed">{s.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Perks */}
        <section className="w-full py-16 sm:py-20 bg-pink-50/50">
          <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16">
            <div className="flex flex-col items-center text-center mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {PERKS.map((perk) => (
                <div key={perk.title} className="flex flex-col p-6 rounded-2xl bg-white border border-pink-200/50 hover:border-brand-purple/30 transition-colors">
                  <span className="text-3xl mb-4">{perk.icon}</span>
                  <h3 className="font-display font-bold text-brand-purple-dark text-base mb-2">{perk.title}</h3>
                  <p className="text-brand-purple-dark/80 text-sm leading-relaxed">{perk.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="w-full py-16 sm:py-20">
          <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16">
            <div className="flex flex-col items-center text-center mb-12">
              ...
              <h2 className="font-display font-bold text-brand-purple-dark text-2xl sm:text-3xl xl:text-4xl mb-3">
                The more you refer, the more you earn
              </h2>
              <p className="text-brand-purple-dark/80 text-base max-w-xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 max-w-4xl mx-auto">
              {TIERS.map((tier, i) => (
                ...
                >
                  ...
                  <p className="text-xs tracking-wide text-brand-purple-dark/80 mb-1">{tier.refs}</p>
                  <p className="font-display font-bold text-brand-purple-dark text-xl mb-1">{tier.reward}</p>
        ...
        <section className="w-full py-16 sm:py-20 bg-pink-50/50">
          <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 text-center">
            ...
            <p className="text-brand-purple-dark/80 text-base mb-8 max-w-md mx-auto">
