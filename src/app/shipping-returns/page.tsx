...
export default function Page() {
  ...
  return (
    ...
    >
      {zones.map(zone => (
        <section key={zone.id}>
          <h2 className="font-display text-2xl text-brand-purple-dark">{zone.name}</h2>
          <ul>
            {zone.rates.map(rate => {
      ...
      <h2 className="font-display text-2xl text-brand-purple-dark">{policy.returnsHeadline}</h2>
      <p>{policy.returnsBody}</p>

      <h2 className="font-display text-2xl text-brand-purple-dark">{policy.damageHeadline}</h2>
