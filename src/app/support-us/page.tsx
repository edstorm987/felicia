  ...
  return (
    <>
      ...
      <main className="w-full bg-pink-50 min-h-screen">
        <section className="w-full pt-28 pb-16 sm:pt-36 sm:pb-20 bg-pink-50/50">
          <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 text-center">
            ...
            <p className="text-brand-purple-dark/80 max-w-3xl mx-auto">{intro}</p>
          </div>
        </section>
        ...
        <section className="w-full pb-20">
          <div className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-12">
            <div className="rounded-3xl border border-brand-purple/25 bg-brand-purple-muted/20 p-8 sm:p-10 text-center">
              ...
              <h2 className="font-display font-bold text-brand-purple-dark text-3xl mb-3">{calloutHeadline}</h2>
              <p className="text-brand-purple-dark/80 mb-6">{calloutBody}</p>
              <Link
                href={calloutHref}
