      ...
      <main className="w-full pt-20 sm:pt-24">
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-14 sm:py-20 lg:py-24">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-center">
              <div>
                ...
                <h1 className="font-display font-bold text-brand-purple-dark leading-[1.05] text-4xl sm:text-5xl xl:text-6xl 2xl:text-7xl mb-6">
                ...
                <p className="text-brand-purple-dark/80 text-base sm:text-lg leading-relaxed">
              ...
              <div className="relative aspect-[4/5] sm:aspect-[5/4] lg:aspect-square rounded-3xl overflow-hidden border border-pink-200/50">
                <Image
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
              {STATS.map((s) => (
                <div key={s.label} className="text-center">
                  ...
                  <p className="text-xs sm:text-sm tracking-wide text-brand-purple-dark/80">{s.label}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="w-full bg-pink-50">
          <div className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20 lg:py-24">
            <div className="flex flex-col items-center text-center mb-14 sm:mb-16">
              ...
              <h2 className="font-display font-bold text-brand-purple-dark text-3xl sm:text-4xl xl:text-5xl">From the earth to your hands</h2>
            </div>
            ...
            <div className="space-y-16 sm:space-y-20 lg:space-y-24">
              {PILLARS.map((p, i) => (
                ...
                >
                  <div className={`relative aspect-[4/3] rounded-3xl overflow-hidden border border-pink-200/50 ${i % 2 === 1 ? "lg:order-last" : ""}`}>
                    <Image
                      src={p.img}
                      alt={p.alt}
                      fill
                  ...
                  <div>
                    ...
                    <h3 className="font-display font-bold text-brand-purple-dark text-2xl sm:text-3xl xl:text-4xl mb-4 leading-tight">
                      {p.title}
                    </h3>
                    <p className="text-brand-purple-dark/80 text-base sm:text-lg leading-relaxed">{p.body}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="w-full bg-pink-50/50">
          <div className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20">
            <div className="flex flex-col items-center text-center mb-12">
              ...
              <h2 className="font-display font-bold text-brand-purple-dark text-3xl sm:text-4xl xl:text-5xl mb-4">Three co-operatives, named</h2>
              ...
              {CO_OPS.map((c) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="font-display text-lg font-semibold text-brand-purple-dark mb-2">{c.name}</h3>
                    <p className="text-sm text-brand-purple-dark/80 leading-relaxed">{c.detail}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="w-full bg-pink-50">
          <div className="w-full max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 py-16 sm:py-20">
            ...
            <h2 className="font-display font-bold text-brand-purple-dark text-3xl sm:text-4xl xl:text-5xl mb-7 leading-tight">
              The trade-offs we&apos;re still working on
            </h2>
            <div className="space-y-6 text-brand-purple-dark/80 text-base sm:text-lg leading-relaxed">
              <p>
                <span className="text-brand-purple-dark font-medium">Air freight.</span> About 27% of our shipments still travel by air to
              ...
              <p>
                <span className="text-brand-purple-dark font-medium">Glass weight.</span> Glass dispensers are heavier to ship than plastic.
              ...
              <p>
                <span className="text-brand-purple-dark font-medium">Certifications.</span> We don&apos;t hold most major ‘fair-trade’ or
