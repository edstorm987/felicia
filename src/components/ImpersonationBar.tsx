      ...
      <div className="flex items-center gap-2 shrink-0">
        {allowed && (
          <>
            <a
              href="/"
              className="text-xs px-2.5 py-1 rounded-lg bg-pink-50/10 hover:bg-pink-50/20 transition-colors"
            >
              Storefront ↗
            </a>
            <a
        ...
        <button
          ...
          className={`text-xs px-3 py-1.5 rounded-lg font-semibold transition-colors ${
            allowed
              ? "bg-pink-50 text-brand-amber hover:bg-pink-50/80"
