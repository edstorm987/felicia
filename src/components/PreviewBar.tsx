...
export default function PreviewBar() {
  ...
  if (!on) return null;
  return (
    <div className="fixed top-0 inset-x-0 z-[60] bg-brand-amber/90 text-brand-purple-dark text-[12px] sm:text-sm font-medium flex items-center justify-center gap-3 py-1.5 backdrop-blur-sm">
      ...
      <button
        ...
        className="px-2 py-0.5 rounded bg-pink-50/15 hover:bg-pink-50/25"
      >
        Exit preview
      </button>
    </div>
