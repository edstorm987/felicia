...
export default function ProductDetail({ product, compact = false }: { product: Product; compact?: boolean }) {
  ...
  return (
    <>
      {/* Breadcrumb */}
      <div className="w-full bg-pink-50 border-b border-pink-200/50">
        <div className="w-full max-w-7xl xl:max-w-screen-xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-4">
          <nav className="text-xs tracking-[0.18em] uppercase text-brand-purple-dark/80">
            <Link href="/" className="hover:text-brand-purple-dark transition-colors">Home</Link>
            <span className="mx-2">/</span>
            <Link href="/#shop" className="hover:text-brand-purple-dark transition-colors">Shop</Link>
            <span className="mx-2">/</span>
            <span className="text-brand-purple-dark/80">{product.name}</span>
          </nav>
        </div>
      </div>
        ...
        <div className="w-full max-w-7xl xl:max-w-screen-xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-10 sm:py-14 lg:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16">
            ...
            <div className="flex flex-col gap-4">
              <div className="relative aspect-square w-full rounded-3xl overflow-hidden bg-gradient-to-br from-brand-purple-muted via-brand-black-card to-brand-purple-dark border border-pink-200/50">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  {format === "bar" ? (
                    <div className="w-52 h-36 sm:w-64 sm:h-44 rounded-2xl bg-gradient-to-br from-brand-orange/25 to-brand-purple/35 border border-pink-200 flex flex-col items-center justify-center shadow-2xl">
                      <p className="font-display text-brand-purple-dark text-base sm:text-lg font-bold tracking-[0.3em]">ODO</p>
                      <div className="w-10 h-px bg-brand-amber/60 my-2" />
                      <p className="text-brand-purple-dark/80 text-[10px] tracking-widest uppercase">Bar · by Felicia</p>
                      <p className="text-brand-purple-dark/80 text-[9px] mt-1 tracking-widest uppercase">
                        {product.name.replace("Odo ", "")}
                      </p>
                    </div>
                  ) : (
                    <div className="w-40 h-48 sm:w-48 sm:h-60 rounded-b-[1.75rem] rounded-t-xl bg-gradient-to-br from-brand-amber/25 to-brand-orange/30 border border-pink-200 flex flex-col items-center justify-center shadow-2xl relative">
                      <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-20 sm:w-24 h-4 rounded-md bg-white border border-pink-200" />
                      <p className="font-display text-brand-purple-dark text-base sm:text-lg font-bold tracking-[0.3em]">ODO</p>
                      <div className="w-10 h-px bg-brand-amber/60 my-2" />
                      <p className="text-brand-purple-dark/80 text-[10px] tracking-widest uppercase">Jar · by Felicia</p>
                      <p className="text-brand-purple-dark/80 text-[9px] mt-1 tracking-widest uppercase">
                        {product.name.replace("Odo ", "")}
                      </p>
                    </div>
                ...
                <p className="absolute bottom-5 right-5 text-[10px] tracking-widest uppercase text-brand-purple-dark/80">
              ...
              <div className="hidden lg:block mt-2 space-y-4">
                ...
                {product.description.map((p, i) => (
                  <p key={i} className="text-sm xl:text-base text-brand-purple-dark/80 leading-relaxed">{p}</p>
                ))}
            ...
            <div className="flex flex-col">
              ...
              <h1 className="font-display font-bold text-brand-purple-dark text-3xl sm:text-4xl xl:text-5xl leading-tight mb-4">
                {product.name}
              </h1>
              ...
              >
                <div className="flex gap-0.5">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <span
                      key={i}
                      className={`text-base ${i < Math.round(product.rating) ? "text-brand-amber" : "text-brand-purple-dark/80"}`}
                    >
                      ★
                    </span>
                  ))}
              ...
              <div className="flex items-baseline gap-3 mb-2">
                ...
                {product.badge === "Save £3" && (
                  <span className="text-sm text-brand-purple-dark/80 line-through">£38.00</span>
                )}
              </div>
              <p className="text-xs text-brand-purple-dark/80 mb-7">
                Or 4 interest-free payments of £{(displayPrice / 4).toFixed(2)} with{" "}
                <span className="text-brand-purple-dark/80 font-medium">Klarna</span>
              </p>

              {/* Bullets */}
              <ul className="space-y-2.5 mb-8">
                {activeContent.shortBullets.map((b) => (
                  <li key={b} className="flex items-start gap-3 text-sm xl:text-base text-brand-purple-dark/80 leading-relaxed">
              ...
              <div className="lg:hidden mb-6">
                <p className="text-sm xl:text-base text-brand-purple-dark/80 leading-relaxed">
                ...
                {readMore && (
                  <div className="mt-3 space-y-3">
                    ...
                    {(frag?.description ?? fc?.description) && (
                      <div className="border-t border-pink-200/50 pt-3 space-y-2">
                        <p className="text-[10px] tracking-[0.25em] uppercase text-brand-amber">
                          {frag?.note ?? fc?.tagline ?? "About this option"}
                        </p>
                        {(frag?.description ?? fc?.description ?? []).map((p, i) => (
              ...
              {product.fragrances.length > 1 && (
                <div className="mb-5">
                  <label className="block text-[11px] tracking-[0.22em] uppercase text-brand-purple-dark/80 mb-2.5">Scent</label>
                        ...
                        <button
                          ...
                          className={`px-4 py-2.5 rounded-full text-xs font-medium border transition-all tracking-wide ${
                            fragrance === f
                              ...
                              : "border-pink-200 bg-white text-brand-purple-dark/80 hover:border-white/25 hover:text-brand-purple-dark"
                          }`}
                        >
              ...
              {product.formats && product.formats.length > 0 && (
                <div className="mb-5">
                  <label className="block text-[11px] tracking-[0.22em] uppercase text-brand-purple-dark/80 mb-2.5">Format</label>
                        ...
                        <button
                          ...
                          className={`relative flex items-center gap-4 p-4 rounded-xl border transition-all text-left ${
                            format === f
                              ...
                              : "border-pink-200 bg-white hover:border-white/25"
                          }`}
                        >
                          <div className="shrink-0 w-14 h-14 rounded-lg bg-gradient-to-br from-brand-purple-muted to-brand-black-card border border-pink-200/50 flex items-center justify-center">
                            <span className="text-xl text-brand-purple-dark/80">{icon}</span>
                          </div>
                          <div className="min-w-0">
                            <p className="text-sm font-medium text-brand-purple-dark capitalize">{f}</p>
                            <p className="text-[10px] tracking-wide uppercase text-brand-purple-dark/80 mt-0.5">{desc}</p>
                          </div>
                          {format === f && (
              ...
              {/* Size selector — THIRD */}
              <div className="mb-5">
                <label className="block text-[11px] tracking-[0.22em] uppercase text-brand-purple-dark/80 mb-2.5">Size</label>
                  ...
                  {activeSizes.map((s) => (
                    <button
                      ...
                      className={`px-5 py-3 rounded-xl text-sm font-medium border transition-all ${
                        size.label === s.label
                          ? "border-brand-orange bg-brand-orange/10 text-brand-purple-dark"
                          : "border-pink-200 bg-white text-brand-purple-dark/80 hover:border-white/25"
                      }`}
                    >
              ...
              <div className="flex items-stretch gap-3 mb-4">
                <div className="flex items-center bg-white border border-pink-200 rounded-xl">
                  <button
                    ...
                    className="w-12 h-full text-brand-purple-dark/80 hover:text-brand-purple-dark transition-colors text-lg"
                    aria-label="Decrease quantity"
                  >
                    −
                  </button>
                  <span className="w-10 text-center text-brand-purple-dark font-medium">{qty}</span>
                  <button
              ...
              {/* Trust row */}
              <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-brand-purple-dark/80 mb-6">
              ...
              {/* Certification */}
              <div className="flex items-center gap-4 p-5 rounded-xl bg-white border border-pink-200/50">
                ...
                <div>
                  <p className="text-sm font-medium text-brand-purple-dark">Ethical by nature</p>
        ...
        <div className="w-full max-w-7xl xl:max-w-screen-xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            <div className="lg:col-span-4">
              ...
              <h2 className="font-display font-bold text-brand-purple-dark text-3xl xl:text-4xl leading-tight mt-3">
                Why {product.name}
              </h2>
            </div>
      ...
      <section className="w-full bg-pink-50">
        <div className="w-full max-w-7xl xl:max-w-screen-xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="font-display font-bold text-brand-purple-dark text-3xl xl:text-4xl mt-3">What it does</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 xl:gap-6">
            {product.benefits.map((b) => (
              <div
                key={b.title}
                className="flex flex-col items-center text-center p-7 xl:p-8 rounded-2xl bg-white border border-pink-200/50 hover:border-brand-orange/25 transition-all duration-300"
              >
                <div className="text-3xl mb-4">{b.icon}</div>
                <h3 className="font-display text-lg font-semibold text-brand-purple-dark mb-2.5">{b.title}</h3>
                <p className="text-sm text-brand-purple-dark/80 leading-relaxed">{b.body}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="w-full max-w-7xl xl:max-w-screen-xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16">
            <div>
              ...
              <h2 className="font-display font-bold text-brand-purple-dark text-3xl xl:text-4xl mt-3 mb-7">Every element, named</h2>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {activeContent.ingredients.map((ing) => (
                  <li
                    key={ing.name}
                    className="flex items-center justify-between gap-3 px-5 py-4 rounded-xl bg-white border border-pink-200/50"
                  >
                    <span className="text-sm text-brand-purple-dark font-medium">{ing.name}</span>
                    {ing.note && (
                      <span className="text-[10px] tracking-wide text-brand-purple-dark/80 bg-white/5 px-2.5 py-1 rounded-full whitespace-nowrap">
                        {ing.note}
                      </span>
                    )}
                  </li>
            ...
            <div>
              ...
              <h2 className="font-display font-bold text-brand-purple-dark text-3xl xl:text-4xl mt-3 mb-7">The ritual</h2>
              <div className="p-7 xl:p-8 rounded-2xl bg-gradient-to-br from-brand-purple-muted/40 to-brand-black-card border border-pink-200/50">
                <p className="text-sm xl:text-base text-brand-purple-dark/80 leading-relaxed">{activeContent.directions}</p>
              </div>

              <div className="mt-6 grid grid-cols-2 gap-3">
                <div className="p-5 rounded-xl bg-white border border-pink-200/50">
                  <p className="text-[10px] tracking-widest uppercase text-brand-purple-dark/80 mb-1">Shipping</p>
                  <p className="text-sm text-brand-purple-dark">£4.99 standard · free over £30</p>
                </div>
                <div className="p-5 rounded-xl bg-white border border-pink-200/50">
                  <p className="text-[10px] tracking-widest uppercase text-brand-purple-dark/80 mb-1">Returns</p>
                  <p className="text-sm text-brand-purple-dark">30-day, no questions</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-7xl xl:max-w-screen-xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-1">
              ...
              <h2 className="font-display font-bold text-brand-purple-dark text-3xl xl:text-4xl mt-3 mb-5">
                Felt by those who know
              </h2>
              <div className="flex items-center gap-3 mb-5">
                <span className="font-display text-4xl font-bold text-brand-purple-dark">{product.rating.toFixed(1)}</span>
                <div className="flex gap-0.5">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <span
                      key={i}
              ...
              <p className="text-sm text-brand-purple-dark/80">Based on {product.reviewCount} verified reviews</p>
            </div>

            <div className="lg:col-span-2 space-y-4">
              {displayReviews.length === 0 ? (
                <p className="text-brand-purple-dark/80 text-sm py-8">No reviews yet — be the first.</p>
              ) : displayReviews.map((r, idx) => (
                <div
                  key={r.name + idx}
                  className="p-6 xl:p-7 rounded-2xl bg-white border border-pink-200/50"
                >
                  <div className="flex items-center justify-between gap-3 mb-3">
                    ...
                    <span className="text-[10px] tracking-widest uppercase text-brand-purple-dark/80">Verified</span>
                  </div>
                  {r.title && (
                    <h4 className="font-display text-lg font-semibold text-brand-purple-dark mb-2">{r.title}</h4>
                  )}
                  <p className="text-sm xl:text-base text-brand-purple-dark/80 leading-relaxed mb-4">&ldquo;{r.body}&rdquo;</p>
                  <div className="flex items-center gap-3 pt-4 border-t border-pink-200/50">
                    ...
                    <div>
                      <p className="text-sm font-medium text-brand-purple-dark">{r.name}</p>
                      <p className="text-xs text-brand-purple-dark/80">{r.location}</p>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <section className="w-full bg-pink-50/50">
        <div className="w-full max-w-7xl xl:max-w-screen-xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-16 sm:py-20">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="font-display font-bold text-brand-purple-dark text-3xl xl:text-4xl mt-3">Complete the ritual</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 xl:gap-6">
            {related.map((p) => (
              <Link
                ...
                className="group flex items-center gap-5 p-5 xl:p-6 rounded-2xl bg-white border border-pink-200/50 hover:border-brand-orange/25 transition-all"
              >
                <div className="shrink-0 w-24 h-24 rounded-xl bg-gradient-to-br from-brand-purple-muted via-brand-black-card to-brand-purple-dark flex items-center justify-center border border-pink-200/50">
                  <span className="font-display text-brand-purple-dark/80 text-xs tracking-[0.25em]">ODO</span>
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] tracking-[0.22em] uppercase text-brand-purple-dark/80 mb-1">{p.tagline}</p>
                  <h3 className="font-display text-lg font-bold text-brand-purple-dark group-hover:text-brand-orange transition-colors truncate">
                    {p.name}
                  </h3>
                  <p className="text-sm text-brand-orange mt-1">£{p.price.toFixed(2)}</p>
                </div>
                <span className="shrink-0 text-brand-purple-dark/80 group-hover:text-brand-orange transition-colors">→</span>
              </Link>
            ))}
          </div>
        </div>
