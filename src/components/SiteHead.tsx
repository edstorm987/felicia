...
function CookieBanner() {
  ...
  return (
    <>
      <div className="fixed bottom-4 left-4 right-4 sm:left-6 sm:right-auto sm:max-w-sm z-[350] rounded-2xl bg-pink-50/50 border border-pink-200 shadow-2xl p-5">
        <div className="flex items-center justify-between gap-2 mb-2">
          <p className="text-[11px] tracking-[0.22em] uppercase text-brand-amber">{headline}</p>
          <ComplianceBadge mode={mode} />
        </div>
        <p className="text-sm text-brand-purple-dark/80 leading-relaxed mb-4">
          {message}{" "}
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
            ...
            className="text-xs text-brand-purple-dark/80 hover:text-brand-purple-dark text-center py-1"
          >
            Manage preferences
          </button>
        </div>
