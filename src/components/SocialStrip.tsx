...
export default function SocialStrip() {
  return (
    <div className="w-full bg-pink-50 pb-10 overflow-hidden">
      <div className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 xl:px-16">
        ...
        <div className="lg:hidden -mx-6 sm:-mx-10 px-6 sm:px-10">
          ...
          <p className="text-center text-[11px] tracking-widest uppercase text-brand-purple-dark/80 mt-2">← Swipe →</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="h-full rounded-2xl overflow-hidden bg-white flex flex-col shadow-2xl shadow-black/70">
      ...
      <div className="px-3 py-2.5 flex items-center gap-2 shrink-0">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[11px] font-bold text-brand-purple-dark truncate">{tile.handle}</p>
      ...
      <div className="px-3 pt-2.5 pb-3 shrink-0">
        ...
        <p className="text-[11px] font-bold text-brand-purple-dark mb-1">{tile.likes} likes</p>
        <p className="text-[10px] text-brand-purple-dark/80 leading-snug line-clamp-3">
  ...
  return (
    <div className="h-full rounded-2xl overflow-hidden flex flex-col shadow-2xl shadow-black/70 relative">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center">
        <div className="w-14 h-14 rounded-full bg-white/15 backdrop-blur-sm border-2 border-pink-200/500 flex items-center justify-center shadow-xl">
    ...
    <div className="h-full rounded-2xl bg-white shadow-2xl shadow-black/70 overflow-hidden flex flex-col">
      ...
      <div className="px-3 py-2.5 border-b border-gray-100 bg-gray-50/80 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[12px] font-semibold text-brand-purple-dark">{tile.handle}</p>
        ...
        {tile.messages.map((m, i) => (
          <div key={i} className={`flex ${m.from === "us" ? "justify-end" : "justify-start"} items-end gap-1.5`}>
            ...
            <div className={`max-w-[82%] px-3 py-2 rounded-2xl ${
              ...
              <p className={`text-[10px] leading-relaxed ${m.from === "us" ? "text-white" : "text-brand-purple-dark/90"}`}>{m.text}</p>
            </div>
          </div>
        ))}
      </div>
...
function ReviewTile({ tile }: { tile: StarCard }) {
  return (
    <div className="h-full rounded-2xl bg-white border border-white/8 shadow-2xl shadow-black/70 flex flex-col p-5">
      ...
      {/* Quote */}
      <p className="text-[11px] sm:text-xs text-brand-purple-dark/80 leading-relaxed flex-1 italic">
      ...
      <div className="border-t border-white/8 mt-4 pt-3 flex items-center gap-2.5">
        ...
        <div>
          <p className="text-[11px] font-semibold text-brand-purple-dark">{tile.name}</p>
          <p className="text-[9px] text-brand-purple-dark/80">{tile.location}</p>
        </div>
