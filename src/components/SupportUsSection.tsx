...
export default function SupportUsSection() {
  ...
  return (
    <section id="support-us" className="w-full bg-gradient-to-br from-[#1a0a2e] via-[#2d1260] to-[#1a0a2e] py-20 sm:py-32 scroll-mt-24 lg:scroll-mt-32 relative overflow-hidden">
      {/* Ambient glow */}
