  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-sm rounded-2xl border border-pink-200 bg-[#0a0e1a] p-5 space-y-4 shadow-2xl shadow-black/40"
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h2 id="confirm-title" className="font-display text-base text-brand-purple-dark">{title}</h2>
