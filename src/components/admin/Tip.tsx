  ...
  return (
    ...
    >
      ...
      {open && (
        <span
          role="tooltip"
          className={`absolute z-[60] ${popPos} w-64 rounded-lg bg-pink-50 border border-brand-orange/25 shadow-xl shadow-black/50 px-3 py-2 text-[11px] leading-relaxed text-brand-purple-dark/80 normal-case tracking-normal pointer-events-none whitespace-pre-line`}
        >
          {resolved}
        </span>
      )}
