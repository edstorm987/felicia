  ...
  // ── Our Story page ───────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { id: "body", label: "Body", fields: [
        { key: "our-story.body.html", label: "Body (HTML)", type: "code", hint: "Standard HTML — h2, p, ul/li, a, strong, em.", default: `<h2 class="font-display text-2xl text-brand-purple-dark">Felicia's vision</h2>
...
<p>Pure ingredients. Honest labels. Fair pay for the women and farmers who make our products possible. Heritage, not trend.</p>` },
  ...
  // ── Privacy page ─────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { id: "body", label: "Body", fields: [
        { key: "privacy.body.html", label: "Body (HTML)", type: "code", hint: "Standard HTML. Update the 'Last updated' line whenever the policy materially changes.", default: `<h2 class=\"font-display text-2xl text-brand-purple-dark\">What we collect</h2>
<ul>
...
<h2 class=\"font-display text-2xl text-brand-purple-dark\">Your rights</h2>
...
<h2 class=\"font-display text-2xl text-brand-purple-dark\">Cookies</h2>
...
<h2 class=\"font-display text-2xl text-brand-purple-dark\">Last updated</h2>
